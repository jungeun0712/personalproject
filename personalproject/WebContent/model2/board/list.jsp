...
<c:forEach var="b" items="${list}">
 ...
 <%-- 첨부파일 표시하기 --%>
  ...
  <c:if test="${empty b.file1}">&nbsp;&nbsp;&nbsp;</c:if>       
    <a href="info.do?id=${b.id}&num=${b.num}&pageNum=${pageNum}&type=${b.type}">${b.subject}</a>
 </td>
 <td>
 ...
 <tr><td colspan="5">
  ...
  <tr><td colspan="5" style="text-align:right">
     <a href="writeForm.do?id=${sessionScope.login}&type=1">[글쓰기]</a></td></tr>
</table></body></html>